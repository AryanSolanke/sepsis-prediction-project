...
class SepsisRecurrentNet(nn.Module):
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train a recurrent neural network for sepsis prediction.")
...
def main() -> None:
    ...
    print(f"Training RNN on device={device}...")
    ...
    print_final_report("Recurrent Neural Network", test_metrics, baseline_metrics=baseline_test_metrics)
